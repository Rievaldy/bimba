...
public class DetailTagihanActivity extends AppCompatActivity {
    ...
    private void initializeData(){
        ...
        if(sessionManagement.getUserAccessSession() == 1  || sessionManagement.getUserAccessSession() == 2 || completeTunggakan.getTunggakan().getTotalHarusBayar()-completeTunggakan.getTunggakan().getBaruDibayarkan() == 0){
